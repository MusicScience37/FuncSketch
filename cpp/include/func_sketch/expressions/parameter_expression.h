...
/*!
 * \file
 * \brief Definition of ParameterExpression structure.
 */
#pragma once
...
/*!
 * \brief Struct of parameter expressions.
 *
 * \note Currently only the parameter "x" exists, so this struct is empty.
 */
 ...
 */
template <>
struct fmt::formatter<func_sketch::expressions::ParameterExpression>
