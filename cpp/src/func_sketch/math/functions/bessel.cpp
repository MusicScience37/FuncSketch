...
MathFunction bessel_j_function(
    ...
    return MathFunction(make_general_math_function<std::tuple<
            AcceptableTypes<Integer, Real>, AcceptableTypes<Real, Complex>>>(
        "bessel_j",
        [complex_bessel_j = std::move(complex_bessel_j)](auto order, auto arg) {
            using ArgType = std::decay_t<decltype(arg)>;
            if constexpr (std::is_same_v<ArgType, Complex>) {
                return complex_bessel_j(static_cast<Real>(order), arg);
            } else {
                return boost::math::cyl_bessel_j(order, arg, BoostMathPolicy());
            }
        }));
}
...
MathFunction bessel_y_function(
    ...
    return MathFunction(make_general_math_function<std::tuple<
            AcceptableTypes<Integer, Real>, AcceptableTypes<Real, Complex>>>(
        "bessel_y",
        [complex_bessel_y = std::move(complex_bessel_y)](auto order, auto arg) {
            using ArgType = std::decay_t<decltype(arg)>;
            if constexpr (std::is_same_v<ArgType, Complex>) {
                return complex_bessel_y(static_cast<Real>(order), arg);
            } else {
                return boost::math::cyl_neumann(order, arg, BoostMathPolicy());
            }
        }));
}
...
MathFunction bessel_i_function(
    ...
    return MathFunction(make_general_math_function<std::tuple<
            AcceptableTypes<Integer, Real>, AcceptableTypes<Real, Complex>>>(
        "bessel_i",
        [complex_bessel_i = std::move(complex_bessel_i)](auto order, auto arg) {
            using ArgType = std::decay_t<decltype(arg)>;
            if constexpr (std::is_same_v<ArgType, Complex>) {
                return complex_bessel_i(static_cast<Real>(order), arg);
            } else {
                return boost::math::cyl_bessel_i(order, arg, BoostMathPolicy());
            }
        }));
}
...
MathFunction bessel_k_function(
    ...
    return MathFunction(make_general_math_function<std::tuple<
            AcceptableTypes<Integer, Real>, AcceptableTypes<Real, Complex>>>(
        "bessel_k",
        [complex_bessel_k = std::move(complex_bessel_k)](auto order, auto arg) {
            using ArgType = std::decay_t<decltype(arg)>;
            if constexpr (std::is_same_v<ArgType, Complex>) {
                return complex_bessel_k(static_cast<Real>(order), arg);
            } else {
                return boost::math::cyl_bessel_k(order, arg, BoostMathPolicy());
            }
        }));
}
        ...
        make_general_math_function<std::tuple<AcceptableTypes<Integer, Real>,
            ...
            [complex_hankel1 = std::move(complex_hankel1)](
                ...
                if constexpr (std::is_same_v<ArgType, Complex>) {
                    ...
                    return boost::math::cyl_hankel_1(
                        order, arg, BoostMathPolicy());
                }
            }));
}
        ...
        make_general_math_function<std::tuple<AcceptableTypes<Integer, Real>,
            ...
            [complex_hankel2 = std::move(complex_hankel2)](
                ...
                if constexpr (std::is_same_v<ArgType, Complex>) {
                    ...
                    return boost::math::cyl_hankel_2(
                        order, arg, BoostMathPolicy());
                }
            }));
}
        ...
        [complex_spherical_bessel_j = std::move(complex_spherical_bessel_j)](
            ...
            if constexpr (std::is_same_v<ArgType, Complex>) {
                ...
                return boost::math::sph_bessel(
                    unsigned_order, arg, BoostMathPolicy());
            }
        }));
}
    ...
    return MathFunction(make_general_math_function<
        ...
        [complex_spherical_bessel_j = std::move(complex_spherical_bessel_j),
            ...
            if constexpr (std::is_same_v<ArgType, Complex>) {
                ...
                return boost::math::sph_hankel_1(
                    unsigned_order, arg, BoostMathPolicy());
            }
        }));
}
    ...
    return MathFunction(make_general_math_function<
        ...
        [complex_spherical_bessel_j = std::move(complex_spherical_bessel_j),
            ...
            if constexpr (std::is_same_v<ArgType, Complex>) {
                ...
                return boost::math::sph_hankel_2(
                    unsigned_order, arg, BoostMathPolicy());
            }
        }));
}
